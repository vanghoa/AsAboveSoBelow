!(function (e, t) {
            ...
            for (
                ...
                switch (s.type) {
                    ...
                    case 'L':
                        ...
                        break;
                    case 'Q':
                        e.addQuad(n, a, s.x1, s.y1, s.x, s.y),
                            (n = s.x),
                            (a = s.y);
                        break;
                    case 'C':
        ...
        (M.DICT = function (e) {
            for (
                ...
                var o = parseInt(r[a], 0),
                    s = e[o];
                t = (t = t.concat(M.OPERAND(s.value, s.type))).concat(
                    M.OPERATOR(o)
                );
            }
            return t;
    ...
    var $ = {
        ...
        ScriptList: ((Q.prototype = Object.create(X.prototype)).constructor =
            Q),
        FeatureList: ((K.prototype = Object.create(X.prototype)).constructor =
            K),
        LookupList: ((J.prototype = Object.create(X.prototype)).constructor =
            J),
        ushortList: V,
        tableList: Y,
        recordList: j,
    ...
    var ue = {
            ...
            make: function (e) {
                ...
                if (
                    ...
                    (i.searchRange =
                        2 *
                        Math.pow(2, Math.floor(Math.log(p - c) / Math.log(2)))),
                    (i.entrySelector =
                        Math.log(i.searchRange / 2) / Math.log(2)),
            ...
            case 2:
                ...
                for (var t = 0; t < e.numberOfGlyphs; t++)
                    e.glyphNameIndex[t] < he.length
                        ...
                        : (this.names[t] =
                              e.names[e.glyphNameIndex[t] - he.length]);
                break;
            case 2.5:
                this.names = new Array(e.numberOfGlyphs);
    ...
    function Ge(v, m, e) {
        ...
        return (
            (function e(t) {
                for (
                    var r, n, a, o, s, i, u, l, p, c, h, f, d = 0;
                    d < t.length;
                    ...
                    switch (((d += 1), g)) {
                        ...
                        default:
                            g < 32
                                ...
                                ? ((r = t[d]),
                                  (d += 1),
                                  E.push(256 * (g - 247) + r + 108))
                                : g < 255
                                ? ((r = t[d]),
                                  (d += 1),
                                  E.push(256 * -(g - 251) - r - 108))
                                : ((r = t[d]),
                                  (n = t[d + 1]),
                                  (a = t[d + 2]),
                                  (o = t[d + 3]),
    ...
    var He = {
        parse: function (r, n, a, e) {
            ...
            e.lowMemory
                ...
                : ((y = Oe(r, n + f.charStrings)),
                  (a.nGlyphs = y.objects.length));
            ...
            s.lowMemory
                ? (function (e, t, r, n, a) {
                      ...
                      for (var i = new ie.Parser(t, r), u = 0; u < a; u += 1)
                          u < n &&
                              ((o = i.parseUShort()), (s = i.parseShort())),
                              (e._hmtxTableData[u] = {
                                  advanceWidth: o,
                                  leftSideBearing: s,
                              });
                ...
                : (function (e, t, r, n, a) {
                      for (
                          var o, s, i = new ie.Parser(e, t), u = 0;
                          u < n;
                          u += 1
                      ) {
                          u < r &&
                            ...
                            function (e) {
                                return new $.Table(
                                    ...
                                    $.tableList('chainRule', e, function (e) {
                                        ...
                                        return (
                                            e.lookupRecords.forEach(function (
                                                e,
                                                t
                                            ) {
                                                r = r
                    ...
                    Object.assign(
                        {
                            ...
                            sCapHeight: mt(e, 'HIKLEFJMNTZBDPRAGOQSUVWXY', b)
                                .yMax,
            ...
            if ((w.argument(n.length === l, 'Bad flags.'), 0 < s.length)) {
                ...
                if (0 < l) {
                    ...
                    for (var v = 0, m = 0; m < l; m += 1)
                        (a = n[m]),
                            ((f = d[m]).x = Ct(o, a, v, 2, 16)),
                            (v = f.x);
                    for (var y = 0, b = 0; b < l; b += 1)
                        (a = n[b]),
                            ((f = d[b]).y = Ct(o, a, y, 4, 32)),
                            (y = f.y);
                }
                e.points = d;
            } else e.points = [];
        ...
        for (
            var r = (function (e) {
                    for (var t = [], r = [], n = 0; n < e.length; n += 1) {
                        var a = e[n];
                        r.push(a),
                            a.lastPointOfContour && (t.push(r), (r = []));
                    }
                    return (
                        w.argument(
                            0 === r.length,
    ...
    ((kt.prototype = Tt.prototype =
        {
            ...
            expandCoverage: function (e) {
                ...
                for (var t = [], r = e.ranges, n = 0; n < r.length; n++)
                    for (
                        var a = r[n], o = a.start, s = a.end, i = o;
                        i <= s;
                        i++
                    )
                        t.push(i);
                    ...
                    ? ((o = e),
                      ...
                      (u._push = function (e) {
                          ...
                          t !== i[e + 1]
                              ? l.push(
                                    e,
                                    Te.ttfGlyphLoader(u, e, wt, o, s + t, Mt)
                                )
    ...
    Object.freeze(Yt),
        ...
        (Zt.prototype.distance = function (e, t, r, n) {
            return (
                this.x * Yt.distance(e, t, r, n) +
                this.y * jt.distance(e, t, r, n)
            );
        }),
    ...
    function hr(e, t) {
        ...
        for (
            ...
            l !== a && o.setRelative(l, l, p, s),
                (l = l.nextPointOnContour) !== u;
    ...
    (Nt.prototype.exec = function (e, t) {
        ...
        if (!(2 < this._errorState)) {
            ...
            if (!n || n.ppem !== t) {
                ...
                if (!a) {
                    (er.prototype = $t),
                        ((a = this._fpgmState =
                            new er('fpgm', r.tables.fpgm)).funcs = []),
                        (a.font = r),
                        O.DEBUG &&
                ...
                (er.prototype = a),
                    ((n = this._prepState =
                        new er('prep', r.tables.prep)).ppem = t);
                var o = r.tables.cvt;
                if (o)
                    for (
        ...
        (Ft = function (e, t) {
            ...
            if (((er.prototype = t), i)) {
                ...
                e.instructions &&
                    ...
                    n.push(
                        new Kt(0, 0),
                        new Kt(Math.round(e.advanceWidth * o), 0)
                    ),
                    O.DEBUG &&
        ...
        (At = function (e, t, r, n) {
            ...
            if (!t.inhibitGridFit) {
                ...
                if (
                    (l.push(
                        new Kt(0, 0),
                        new Kt(Math.round(e.advanceWidth * r), 0)
                    ),
                    Bt(t),
                    (l.length -= 2),
                    O.DEBUG)
        ...
        (Gt = [
            ...
            function (e) {
                var t = e.stack.pop();
                switch (
                    (O.DEBUG && console.log(e.step, 'SZP0[]', t), (e.zp0 = t))
                ) {
                    case 0:
            ...
            function (e) {
                var t = e.stack.pop();
                switch (
                    (O.DEBUG && console.log(e.step, 'SZP1[]', t), (e.zp1 = t))
                ) {
                    case 0:
            ...
            function (e) {
                var t = e.stack.pop();
                switch (
                    (O.DEBUG && console.log(e.step, 'SZP2[]', t), (e.zp2 = t))
                ) {
                    case 0:
            ...
            function (e) {
                var t = e.stack.pop();
                O.DEBUG && console.log(e.step, 'SCVTCI[]', t),
                    (e.cvCutIn = t / 64);
            },
            void 0,
            void 0,
            function (e) {
                var t = e.stack;
                O.DEBUG && console.log(e.step, 'DUP[]'),
                    t.push(t[t.length - 1]);
            },
            ur,
            function (e) {
            ...
            function (e) {
                ...
                var t = e.stack,
                    ...
                    o = n;
                for (
                    O.DEBUG && console.log(e.step, 'FDEF[]', a);
                    45 !== r[++n];
            ...
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'WCVTP', r, n),
                    (e.cvt[n] = r / 64);
            },
            function (e) {
                var t = e.stack,
                    r = t.pop();
                O.DEBUG && console.log(e.step, 'RCVT', r),
                    t.push(64 * e.cvt[r]);
            },
            vr.bind(void 0, 0),
            vr.bind(void 0, 1),
            ...
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'LT[]', r, n),
                    t.push(n < r ? 1 : 0);
            },
            function (e) {
                var t = e.stack,
            ...
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'GT[]', r, n),
                    t.push(r < n ? 1 : 0);
            },
            function (e) {
                var t = e.stack,
            ...
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'EQ[]', r, n),
                    t.push(r === n ? 1 : 0);
            },
            function (e) {
                var t = e.stack,
            ...
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'AND[]', r, n),
                    t.push(r && n ? 1 : 0);
            },
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'OR[]', r, n),
                    t.push(r || n ? 1 : 0);
            },
            function (e) {
                var t = e.stack,
            ...
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'DIV[]', r, n),
                    t.push((64 * n) / r);
            },
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'MUL[]', r, n),
                    t.push((n * r) / 64);
            },
            function (e) {
                var t = e.stack,
            ...
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'MAX[]', r, n),
                    t.push(Math.max(n, r));
            },
            function (e) {
                var t = e.stack,
                    r = t.pop(),
                    n = t.pop();
                O.DEBUG && console.log(e.step, 'MIN[]', r, n),
                    t.push(Math.min(n, r));
            },
            function (e) {
                var t = e.stack.pop();
            ...
            function (e) {
                var t = e.stack.pop(),
                    r = e.stack.pop();
                switch (
                    (O.DEBUG && console.log(e.step, 'INSTCTRL[]', t, r), t)
                ) {
                    case 1:
                    ...
                    return function (e) {
                        return function (e, t) {
                            ...
                            if (e.lookahead.length < t.lookaheadCoverage.length)
                                return [];
                            for (
                                var o = e.lookahead.slice(a);
                                o.length && Mr(o[0].char);
                            ...
                            for (u.reverse(); u.length && Mr(u[0].char); )
                                u.shift();
                ...
                case '41':
                    return function (e) {
                        return function (e, t) {
                            ...
                            if (-1 === n) return null;
                            for (
                                var a = t.ligatureSets[n], o = 0;
                                o < a.length;
                                o++
                            ) {
                                r = a[o];
                                for (var s = 0; s < r.components.length; s++) {
                                    if (e.lookahead[s] !== r.components[s])
                                        break;
        ...
        (Br.prototype.lookupFeature = function (e) {
            ...
            for (
                ...
                for (
                    ...
                    (t = new Lr(o, r)),
                        (Array.isArray(f) && !f.length) || (f = null);
                }
    ...
    function bn(e, t) {
        ...
        var a,
            ...
            S = ie.getTag(y, 0);
        if (
            S === String.fromCharCode(0, 1, 0, 0) ||
            'true' === S ||
            'typ1' === S
        )
            (m.outlinesFormat = 'truetype'),
                (b = mn(y, (a = ie.getUShort(y, 4))));
        else if ('OTTO' === S)
            ...
            if (x === String.fromCharCode(0, 1, 0, 0))
                ...
                if ('OTTO' !== x)
                    throw new Error('Unsupported OpenType flavor ' + S);
        ...
        if (g) {
            var A = yn(y, g);
            (m.tables.meta = ht.parse(A.data, A.offset)),
