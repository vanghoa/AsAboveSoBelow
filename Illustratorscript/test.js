    ...
    function render_arr_create() {
        ...
        for (var count = 0; count < target.lines.length; count++) {
            ...
            for (var k = 0; k < targetline_chars.length; k++) {
                ...
                if (tong != 0) {
                    kern =
                        +targetline_chars[k].insertionPoints[0].kerningValue /
                        70;
                }
                if (k < targetline_chars.length - 1) {
                    kernr =
                        +targetline_chars[k].insertionPoints[1].kerningValue /
                        70;
                }
                tong += kern;
                // check
    ...
    for (var i = 0; i < render_arr.length; i++) {
        for (var k = 0; k < render_arr[i].length; k++) {
            if (render_arr[i][k].is) {
                target.lines[i].characters[k].appliedFont = render_arr[i][k]
                    .altshort
                    ? altshort
                    : alt;
                ...
                target.lines[i].characters[k].appliedFont = regular;
            }
        }
    }
}
