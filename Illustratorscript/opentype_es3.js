...
!function (e, t) {
  'object' == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && 'undefined' != typeof module ? t(exports) : 'function' == typeof define && define.amd ? define(['exports'], t) : t((e = e || self).opentype = {});
}(void 0, function (O) {
  'use strict';
  ...
  function T(e, t, r) {
    var n, a, o, s, i, u;
    for (n = S(e, 5, 257), a = S(e, 5, 1), o = S(e, 4, 4), s = 0; s < 19; ++s) v[s] = 0;
    for (s = 0; s < o; ++s) {
      var l = S(e, 3, 0);
      v[d[s]] = l;
    }
  ...
  function k(e, t, r) {
    for (;;) {
      var n,
        ...
        i = x(e, t);
      if (256 === i) return u;
      if (i < 256) e.dest[e.destLen++] = i;else for (n = S(e, p[i -= 257], c[i]), a = x(e, r), s = o = e.destLen - S(e, h[a], f[a]); s < o + n; ++s) e.dest[e.destLen++] = e.dest[s];
    }
  }
  function U(e) {
  ...
  }(i, l), n(p, c, 4, 3), n(h, f, 2, 1), p[28] = 0, c[28] = 258;
  ...
  R.prototype.isEmpty = function () {
    ...
    for (var h = 0; h <= 1; h++) {
      ...
      if (0 != d) {
        ...
        if (!(v < 0)) {
          ...
          0 < m && m < 1 && (0 === h && this.addX(E(u[h], l[h], p[h], c[h], m)), 1 === h && this.addY(E(u[h], l[h], p[h], c[h], m)));
          var y = (-f - Math.sqrt(v)) / (2 * d);
          0 < y && y < 1 && (0 === h && this.addX(E(u[h], l[h], p[h], c[h], y)), 1 === h && this.addY(E(u[h], l[h], p[h], c[h], y)));
        }
      } else {
        if (0 == f) continue;
        var b = -g / f;
        0 < b && b < 1 && (0 === h && this.addX(E(u[h], l[h], p[h], c[h], b)), 1 === h && this.addY(E(u[h], l[h], p[h], c[h], b)));
      }
    }
  ...
  }, B.prototype.curveTo = B.prototype.bezierCurveTo = function (e, t, r, n, a, o) {
    this.commands.push({
      type: 'C',
      x1: e,
      y1: t,
  ...
  }, B.prototype.quadTo = B.prototype.quadraticCurveTo = function (e, t, r, n) {
    this.commands.push({
      type: 'Q',
      x1: e,
      y1: t,
    ...
    for (var e = new R(), t = 0, r = 0, n = 0, a = 0, o = 0; o < this.commands.length; o++) {
  ...
  M.BYTE = function (e) {
    return w.argument(0 <= e && e <= 255, 'Byte value should be between 0 and 255.'), [e];
  }, G.BYTE = F(1), M.CHAR = function (e) {
    return [e.charCodeAt(0)];
  }, G.CHAR = F(1), M.CHARARRAY = function (e) {
  ...
  }, G.USHORT = F(2), M.SHORT = function (e) {
    return 32768 <= e && (e = -(65536 - e)), [e >> 8 & 255, 255 & e];
  }, G.SHORT = F(2), M.UINT24 = function (e) {
    return [e >> 16 & 255, e >> 8 & 255, 255 & e];
  }, G.UINT24 = F(3), M.ULONG = function (e) {
    return [e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e];
  }, G.ULONG = F(4), M.LONG = function (e) {
    return D <= e && (e = -(2 * D - e)), [e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e];
  }, G.LONG = F(4), M.FIXED = M.ULONG, G.FIXED = G.ULONG, M.FWORD = M.SHORT, G.FWORD = G.SHORT, M.UFWORD = M.USHORT, G.UFWORD = G.USHORT, M.LONGDATETIME = function (e) {
    return [0, 0, 0, 0, e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e];
  }, G.LONGDATETIME = F(8), M.TAG = function (e) {
  ...
  }, G.TAG = F(4), M.Card8 = M.BYTE, G.Card8 = G.BYTE, M.Card16 = M.USHORT, G.Card16 = G.USHORT, M.OffSize = M.BYTE, G.OffSize = G.BYTE, M.SID = M.USHORT, G.SID = G.USHORT, M.NUMBER = function (e) {
    return -107 <= e && e <= 107 ? [e + 139] : 108 <= e && e <= 1131 ? [247 + ((e -= 108) >> 8), 255 & e] : -1131 <= e && e <= -108 ? [251 + ((e = -e - 108) >> 8), 255 & e] : -32768 <= e && e <= 32767 ? M.NUMBER16(e) : M.NUMBER32(e);
  }, G.NUMBER = function (e) {
    return M.NUMBER(e).length;
  }, M.NUMBER16 = function (e) {
    return [28, e >> 8 & 255, 255 & e];
  }, G.NUMBER16 = F(3), M.NUMBER32 = function (e) {
    return [29, e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e];
  }, G.NUMBER32 = F(5), M.REAL = function (e) {
    var t = e.toString(),
    ...
    for (var a = '', o = 0, s = t.length; o < s; o += 1) {
      var i = t[o];
      a += 'e' === i ? '-' === t[++o] ? 'c' : 'b' : '.' === i ? 'a' : '-' === i ? 'e' : i;
    }
    for (var u = [30], l = 0, p = (a += 1 & a.length ? 'f' : 'ff').length; l < p; l += 2) u.push(parseInt(a.substr(l, 2), 16));
    return u;
  }, G.REAL = function (e) {
    return M.REAL(e).length;
  }, M.NAME = M.CHARARRAY, G.NAME = G.CHARARRAY, M.STRING = M.CHARARRAY, G.STRING = G.CHARARRAY, I.UTF8 = function (e, t, r) {
  ...
  M.MACSTRING = function (e, t) {
    ...
    for (var s = [], i = 1 + Math.floor(Math.log(t) / Math.log(2)) / 8 | 0, u = [void 0, M.BYTE, M.USHORT, M.UINT24, M.ULONG][i], l = 0; l < r.length; l += 1) {
      var p = u(r[l]);
    ...
    var r = [];
    if (Array.isArray(t)) for (var n = 0; n < t.length; n += 1) w.argument(e.length === t.length, 'Not enough arguments given for type' + t), r = r.concat(M.OPERAND(e[n], t[n]));else if ('SID' === t) r = r.concat(M.NUMBER(e));else if ('offset' === t) r = r.concat(M.NUMBER32(e));else if ('number' === t) r = r.concat(M.NUMBER(e));else {
      if ('real' !== t) throw new Error('Unknown operand type ' + t);
      r = r.concat(M.REAL(e));
    }
    return r;
  }, M.OP = M.BYTE, G.OP = G.BYTE;
  var _ = 'function' == typeof WeakMap && new WeakMap();
  function X(e, t, r) {
    if (t.length && ('coverageFormat' !== t[0].name || 1 === t[0].value)) for (var n = 0; n < t.length; n += 1) {
      var a = t[n];
      this[a.name] = a.value;
    }
  ...
  function Z(e) {
    1 === e.format ? X.call(this, 'coverageTable', [{
      ...
      type: 'USHORT',
      value: 1
    }].concat(V('glyph', e.glyphs))) : 2 === e.format ? X.call(this, 'coverageTable', [{
      name: 'coverageFormat',
      type: 'USHORT',
      value: 2
  ...
  function Q(e) {
    X.call(this, 'scriptListTable', j('scriptRecord', e, function (e, t) {
      var r = e.script,
        n = r.defaultLangSys;
  ...
  function K(e) {
    X.call(this, 'featureListTable', j('featureRecord', e, function (e, t) {
      var r = e.feature;
      return [{
        name: 'featureTag' + t,
        type: 'TAG',
  ...
  function J(e, r) {
    X.call(this, 'lookupListTable', Y('lookup', e, function (e) {
      ...
      return w.assert(!!t, 'Unable to write GSUB lookup type ' + e.lookupType + ' tables.'), new X('lookupTable', [{
        name: 'lookupType',
        type: 'USHORT',
        value: e.lookupType
      }, {
  ...
  M.CHARSTRING = function (e) {
    ...
    for (var t = [], r = e.fields.length, n = [], a = [], o = 0; o < r; o += 1) {
      var s = e.fields[o],
        i = M[s.type];
      w.argument(void 0 !== i, 'No encoding function for field type ' + s.type + ' (' + s.name + ')');
      var u = e[s.name];
      void 0 === u && (u = s.value);
      var l = i(u);
      'TABLE' === s.type ? (a.push(t.length), t = t.concat([0, 0]), n.push(l)) : t = t.concat(l);
    }
    for (var p = 0; p < n.length; p += 1) {
      var c = a[p],
        h = t.length;
      w.argument(h < 65536, 'Table ' + e.tableName + ' too big.'), t[c] = h >> 8, t[c + 1] = 255 & h, t = t.concat(n[p]);
    }
    return t;
  }, G.TABLE = function (e) {
    for (var t = 0, r = e.fields.length, n = 0; n < r; n += 1) {
      var a = e.fields[n],
        o = G[a.type];
      w.argument(void 0 !== o, 'No sizeOf function for field type ' + a.type + ' (' + a.name + ')');
      var s = e[a.name];
      void 0 === s && (s = a.value), t += o(s), 'TABLE' === a.type && (t += 2);
    }
    return t;
  }, M.RECORD = M.TABLE, G.RECORD = G.TABLE, M.LITERAL = function (e) {
    return e;
    ...
    for (var t = this.parseOffset16List(), r = t.length, n = this.relativeOffset, a = new Array(r), o = 0; o < r; o++) {
      ...
      if (0 !== s) {
        if (this.relativeOffset = s, e) {
          for (var i = this.parseOffset16List(), u = new Array(i.length), l = 0; l < i.length; l++) this.relativeOffset = s + i[l], u[l] = e.call(this);
          a[o] = u;
  ...
  oe.prototype.parseScriptList = function () {
    ...
    return this.parsePointer(oe.list(oe.pointer(function () {
      ...
      w.argument(1 <= e && e <= 9, 'GPOS/GSUB lookup type ' + e + ' unknown.');
    ...
    return this.parsePointer32(function () {
      var e = this.parseUShort(),
        t = this.parseUShort();
      return w.argument(1 === e && t < 1, 'GPOS/GSUB feature variations table unknown.'), this.parseRecordList32({
  ...
  var ue = {
      parse: function parse(e, t) {
        var r = {};
        r.version = ie.getUShort(e, t), w.argument(0 === r.version, 'cmap table version should be 0.'), r.numTables = ie.getUShort(e, t + 2);
        ...
        if (r.format = i.parseUShort(), 12 === r.format) !function (e, t) {
          ...
          for (var n = 0; n < r; n += 1) for (var a = t.parseULong(), o = t.parseULong(), s = t.parseULong(), i = a; i <= o; i += 1) e.glyphIndexMap[i] = s, s++;
        }(r, i);else {
          ...
          !function (e, t, r, n, a) {
            ...
            for (var s = new ie.Parser(r, n + a + 14), i = new ie.Parser(r, n + a + 16 + 2 * o), u = new ie.Parser(r, n + a + 16 + 4 * o), l = new ie.Parser(r, n + a + 16 + 6 * o), p = n + a + 16 + 8 * o, c = 0; c < o - 1; c += 1) for (var h = void 0, f = s.parseUShort(), d = i.parseUShort(), g = u.parseShort(), v = l.parseUShort(), m = d; m <= f; m += 1) 0 !== v ? (p = l.offset + l.relativeOffset - 2, p += v, p += 2 * (m - d), 0 !== (h = ie.getUShort(r, p)) && (h = h + g & 65535)) : h = m + g & 65535, e.glyphIndexMap[m] = h;
          }(r, i, e, t, n);
        }
        return r;
      },
      make: function make(e) {
        ...
        for (i.segments = [], t = 0; t < e.length; t += 1) {
          for (var u = e.get(t), l = 0; l < u.unicodes.length; l += 1) a = i, o = u.unicodes[l], s = t, a.segments.push({
            end: o,
            start: o,
            delta: -(o - s),
            offset: 0,
        ...
        for (t = 0; t < p; t += 1) {
          var y = i.segments[t];
          y.end <= 65535 && y.start <= 65535 ? (h = h.concat({
            name: 'end_' + t,
            type: 'USHORT',
            value: y.end
          }), f = f.concat({
            ...
            type: 'USHORT',
            value: y.glyphId
          }))) : c += 1, r || void 0 === y.glyphIndex || (m = (m = (m = m.concat({
            name: 'cmap12Start_' + t,
            type: 'ULONG',
            value: y.start
          })).concat({
        ...
        if (i.segCountX2 = 2 * (p - c), i.searchRange = 2 * Math.pow(2, Math.floor(Math.log(p - c) / Math.log(2))), i.entrySelector = Math.log(i.searchRange / 2) / Math.log(2), i.rangeShift = i.segCountX2 - i.searchRange, i.fields = i.fields.concat(h), i.fields.push({
          name: 'reservedPad',
          type: 'USHORT',
          value: 0
        }), i.fields = i.fields.concat(f), i.fields = i.fields.concat(d), i.fields = i.fields.concat(g), i.fields = i.fields.concat(v), i.cmap4Length = 14 + 2 * h.length + 2 + 2 * f.length + 2 * d.length + 2 * g.length + 2 * v.length, !r) {
          var b = 16 + 4 * m.length;
  ...
  function ve(e) {
    switch (e.version) {
      ...
      case 2.5:
        this.names = new Array(e.numberOfGlyphs);
        for (var r = 0; r < e.numberOfGlyphs; r++) this.names[r] = he[r + e.glyphNameIndex[r]];
        break;
      case 3:
      default:
        this.names = [];
  ...
  be.prototype.bindConstructorValues = function (e) {
    var t, r;
    this.index = e.index || 0, this.name = e.name || null, this.unicode = e.unicode || void 0, this.unicodes = e.unicodes || void 0 !== e.unicode ? [e.unicode] : [], 'xMin' in e && (this.xMin = e.xMin), 'yMin' in e && (this.yMin = e.yMin), 'xMax' in e && (this.xMax = e.xMax), 'yMax' in e && (this.yMax = e.yMax), 'advanceWidth' in e && (this.advanceWidth = e.advanceWidth), Object.defineProperty(this, 'path', (t = e.path, r = t || new B(), {
      configurable: !0,
      get: function get() {
    ...
    var i = (n = n || {}).xScale,
      u = n.yScale;
    if (n.hinting && a && a.hinting && (s = this.path && a.hinting.exec(this, r)), s) o = a.hinting.getCommands(s), e = Math.round(e), t = Math.round(t), i = u = 1;else {
    ...
    function n(e, t, r, n) {
      o.beginPath();
      for (var a = 0; a < e.length; a += 1) o.moveTo(t + e[a].x * n, r + e[a].y * n), o.arc(t + e[a].x * n, r + e[a].y * n, 2, 0, 2 * Math.PI, !1);
      o.closePath(), o.fill();
    }
    e = void 0 !== e ? e : 0, t = void 0 !== t ? t : 0, r = void 0 !== r ? r : 24;
    for (var a = 1 / this.path.unitsPerEm * r, s = [], i = [], u = this.path, l = 0; l < u.commands.length; l += 1) {
      var p = u.commands[l];
      void 0 !== p.x && s.push({
        x: p.x,
        y: -p.y
    ...
    o.fillStyle = 'blue', n(s, e, t, a), o.fillStyle = 'red', n(i, e, t, a);
  }, be.prototype.drawMetrics = function (e, t, r, n) {
    var a;
    t = void 0 !== t ? t : 0, r = void 0 !== r ? r : 0, n = void 0 !== n ? n : 24, a = 1 / this.path.unitsPerEm * n, e.lineWidth = 1, e.strokeStyle = 'black', ye.line(e, t, -1e4, t, 1e4), ye.line(e, -1e4, r, 1e4, r);
    var o = this.xMin || 0,
      s = this.yMin || 0,
      i = this.xMax || 0,
      u = this.yMax || 0,
      l = this.advanceWidth || 0;
    e.strokeStyle = 'blue', ye.line(e, t + o * a, -1e4, t + o * a, 1e4), ye.line(e, t + i * a, -1e4, t + i * a, 1e4), ye.line(e, -1e4, r + -s * a, 1e4, r + -s * a), ye.line(e, -1e4, r + -u * a, 1e4, r + -u * a), e.strokeStyle = 'green', ye.line(e, t + l * a, -1e4, t + l * a, 1e4);
  ...
  var Te = {
    ...
    ttfGlyphLoader: function ttfGlyphLoader(r, e, n, a, o, s) {
      return function () {
        var t = new be({
          index: e,
          font: r
        ...
        }, Se(t, 'xMin', '_xMin'), Se(t, 'xMax', '_xMax'), Se(t, 'yMin', '_yMin'), Se(t, 'yMax', '_yMax'), t;
      };
    },
    cffGlyphLoader: function cffGlyphLoader(r, e, n, a) {
      return function () {
        var t = new be({
          index: e,
          font: r
  ...
  function Oe(e, t, r) {
    ...
    if (0 !== i) {
      ...
      n = t + (i + 1) * u + 2;
      for (var l = t + 3, p = 0; p < i + 1; p += 1) o.push(ie.getOffset(e, l, u)), l += u;
      a = n + o[i];
    } else a = t + 2;
  ...
  function Re(e, t, r) {
    ...
    for (r = void 0 !== r ? r : e.length; n.relativeOffset < r;) {
      var s = n.parseByte();
      s <= 21 ? (12 === s && (s = 1200 + n.parseByte()), a.push([s, o]), o = []) : o.push(Ee(n, s));
    }
    return function (e) {
      for (var t = {}, r = 0; r < e.length; r += 1) {
        var n = e[r][0],
  ...
  function Ce(e, t, r) {
    for (var n, a = {}, o = 0; o < t.length; o += 1) {
      ...
      if (Array.isArray(s.type)) {
        ...
        for (var u = 0; u < s.type.length; u++) void 0 === (n = void 0 !== e[s.op] ? e[s.op][u] : void 0) && (n = void 0 !== s.value && void 0 !== s.value[u] ? s.value[u] : null), 'SID' === s.type[u] && (n = Le(r, n)), i[u] = n;
        a[s.name] = i;
      } else void 0 === (n = e[s.op]) && (n = void 0 !== s.value ? s.value : null), 'SID' === s.type && (n = Le(r, n)), a[s.name] = n;
    }
    return a;
  }
  var we = [{
  ...
  function Me(e, t, r, n) {
    for (var a, o, s = [], i = 0; i < r.length; i += 1) {
      ...
      if (0 !== p && 0 !== c) {
        var h = Ie(e, c + t, p, n);
        if (l._defaultWidthX = h.defaultWidthX, l._nominalWidthX = h.nominalWidthX, 0 !== h.subrs) {
  ...
  function Ge(v, m, e) {
    ...
    if (v.isCIDFont) {
      ...
      T = n._subrs, k = n._subrsBias, t = n._defaultWidthX, U = n._nominalWidthX;
    ...
    function G() {
      E.length % 2 == 0 || L || (I = E.shift() + U), R += E.length >> 1, E.length = 0, L = !0;
    }
    return function e(t) {
      for (var r, n, a, o, s, i, u, l, p, c, h, f, d = 0; d < t.length;) {
        ...
        switch (d += 1, g) {
          ...
          case 3:
            ...
            break;
          case 4:
            1 < E.length && !L && (I = E.shift() + U, L = !0), D += E.pop(), M(w, D);
            break;
          case 5:
            for (; 0 < E.length;) w += E.shift(), D += E.shift(), O.lineTo(w, D);
            break;
          case 6:
            for (; 0 < E.length && (w += E.shift(), O.lineTo(w, D), 0 !== E.length);) D += E.shift(), O.lineTo(w, D);
            break;
          case 7:
            for (; 0 < E.length && (D += E.shift(), O.lineTo(w, D), 0 !== E.length);) w += E.shift(), O.lineTo(w, D);
            break;
          case 8:
            for (; 0 < E.length;) y = w + E.shift(), b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), w = S + E.shift(), D = x + E.shift(), O.curveTo(y, b, S, x, w, D);
            break;
          case 10:
            s = E.pop() + k, (i = T[s]) && e(i);
            break;
          ...
          case 12:
            switch (g = t[d], d += 1, g) {
              case 35:
                y = w + E.shift(), b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), u = S + E.shift(), l = x + E.shift(), p = u + E.shift(), c = l + E.shift(), h = p + E.shift(), f = c + E.shift(), w = h + E.shift(), D = f + E.shift(), E.shift(), O.curveTo(y, b, S, x, u, l), O.curveTo(p, c, h, f, w, D);
                break;
              case 34:
                y = w + E.shift(), b = D, S = y + E.shift(), x = b + E.shift(), u = S + E.shift(), l = x, p = u + E.shift(), c = x, h = p + E.shift(), f = D, w = h + E.shift(), O.curveTo(y, b, S, x, u, l), O.curveTo(p, c, h, f, w, D);
                break;
              case 36:
                y = w + E.shift(), b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), u = S + E.shift(), l = x, p = u + E.shift(), c = x, h = p + E.shift(), f = c + E.shift(), w = h + E.shift(), O.curveTo(y, b, S, x, u, l), O.curveTo(p, c, h, f, w, D);
                break;
              case 37:
                y = w + E.shift(), b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), u = S + E.shift(), l = x + E.shift(), p = u + E.shift(), c = l + E.shift(), h = p + E.shift(), f = c + E.shift(), Math.abs(h - w) > Math.abs(f - D) ? w = h + E.shift() : D = f + E.shift(), O.curveTo(y, b, S, x, u, l), O.curveTo(p, c, h, f, w, D);
                break;
              default:
                console.log('Glyph ' + m.index + ': unknown operator 1200' + g), E.length = 0;
            }
            break;
          case 14:
            0 < E.length && !L && (I = E.shift() + U, L = !0), C && (O.closePath(), C = !1);
            break;
          case 18:
            G();
            break;
          ...
          case 20:
            ...
            break;
          case 21:
            2 < E.length && !L && (I = E.shift() + U, L = !0), D += E.pop(), M(w += E.pop(), D);
            break;
          case 22:
            1 < E.length && !L && (I = E.shift() + U, L = !0), M(w += E.pop(), D);
            break;
          case 23:
            G();
            break;
          case 24:
            for (; 2 < E.length;) y = w + E.shift(), b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), w = S + E.shift(), D = x + E.shift(), O.curveTo(y, b, S, x, w, D);
            w += E.shift(), D += E.shift(), O.lineTo(w, D);
            break;
          case 25:
            for (; 6 < E.length;) w += E.shift(), D += E.shift(), O.lineTo(w, D);
            y = w + E.shift(), b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), w = S + E.shift(), D = x + E.shift(), O.curveTo(y, b, S, x, w, D);
            break;
          case 26:
            for (E.length % 2 && (w += E.shift()); 0 < E.length;) y = w, b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), w = S, D = x + E.shift(), O.curveTo(y, b, S, x, w, D);
            break;
          case 27:
            for (E.length % 2 && (D += E.shift()); 0 < E.length;) y = w + E.shift(), b = D, S = y + E.shift(), x = b + E.shift(), w = S + E.shift(), D = x, O.curveTo(y, b, S, x, w, D);
            break;
          case 28:
            r = t[d], n = t[d + 1], E.push((r << 24 | n << 16) >> 16), d += 2;
            break;
          case 29:
            s = E.pop() + v.gsubrsBias, (i = v.gsubrs[s]) && e(i);
            break;
          case 30:
            for (; 0 < E.length && (y = w, b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), w = S + E.shift(), D = x + (1 === E.length ? E.shift() : 0), O.curveTo(y, b, S, x, w, D), 0 !== E.length);) y = w + E.shift(), b = D, S = y + E.shift(), x = b + E.shift(), D = x + E.shift(), w = S + (1 === E.length ? E.shift() : 0), O.curveTo(y, b, S, x, w, D);
            break;
          case 31:
            for (; 0 < E.length && (y = w + E.shift(), b = D, S = y + E.shift(), x = b + E.shift(), D = x + E.shift(), w = S + (1 === E.length ? E.shift() : 0), O.curveTo(y, b, S, x, w, D), 0 !== E.length);) y = w, b = D + E.shift(), S = y + E.shift(), x = b + E.shift(), w = S + E.shift(), D = x + (1 === E.length ? E.shift() : 0), O.curveTo(y, b, S, x, w, D);
            break;
          default:
            g < 32 ? console.log('Glyph ' + m.index + ': unknown operator ' + g) : g < 247 ? E.push(g - 139) : g < 251 ? (r = t[d], d += 1, E.push(256 * (g - 247) + r + 108)) : g < 255 ? (r = t[d], d += 1, E.push(256 * -(g - 251) - r - 108)) : (r = t[d], n = t[d + 1], a = t[d + 2], o = t[d + 3], d += 4, E.push((r << 24 | n << 16 | a << 8 | o) / 65536));
        }
      }
    }(e), m.advanceWidth = I, O;
  }
  function Be(e, t) {
    var r,
      n = le.indexOf(e);
  ...
  function Fe(e, t, r) {
    for (var n = {}, a = 0; a < e.length; a += 1) {
      var o = e[a],
        s = t[o.name];
      void 0 === s || ke(s, o.value) || ('SID' === o.type && (s = Be(s, r)), n[o.op] = {
        name: o.name,
        type: o.type,
        value: s
      });
  ...
  function Ne(e) {
    ...
    for (var n = 0, a = 0, o = 0; o < r.commands.length; o += 1) {
      ...
      if ('M' === u.type) s = Math.round(u.x - n), i = Math.round(u.y - a), t.push({
        name: 'dx',
        type: 'NUMBER',
        value: s
      }), t.push({
        ...
        type: 'OP',
        value: 21
      }), n = Math.round(u.x), a = Math.round(u.y);else if ('L' === u.type) s = Math.round(u.x - n), i = Math.round(u.y - a), t.push({
        name: 'dx',
        type: 'NUMBER',
        value: s
      }), t.push({
        ...
        type: 'OP',
        value: 5
      }), n = Math.round(u.x), a = Math.round(u.y);else if ('C' === u.type) {
        ...
        s = Math.round(u.x - u.x2), i = Math.round(u.y - u.y2), t.push({
          ...
          type: 'OP',
          value: 8
        }), n = Math.round(u.x), a = Math.round(u.y);
      }
    }
    return t.push({
      name: 'endchar',
  ...
  var He = {
    parse: function parse(r, n, a, e) {
      a.tables.cff = {};
      var t,
        o,
        s,
        i = (t = r, o = n, (s = {}).formatMajor = ie.getCard8(t, o), s.formatMinor = ie.getCard8(t, o + 1), s.size = ie.getCard8(t, o + 2), s.offsetSize = ie.getCard8(t, o + 3), s.startOffset = o, s.endOffset = o + 4, s),
      ...
      var f = h[0];
      if ((a.tables.cff.topDict = f)._privateDict && (a.defaultWidthX = f._privateDict.defaultWidthX, a.nominalWidthX = f._privateDict.nominalWidthX), void 0 !== f.ros[0] && void 0 !== f.ros[1] && (a.isCIDFont = !0), a.isCIDFont) {
        var d = f.fdArray,
          g = f.fdSelect;
        if (0 === d || 0 === g) throw new Error('Font is marked as a CID font, but FDArray and/or FDSelect information is missing');
        var v = Oe(r, d += n),
          m = Me(r, n, v.objects, p.objects);
        f._fdArray = m, g += n, f._fdSelect = function (e, t, r, n) {
          var a,
            o = [],
            s = new ie.Parser(e, t),
            i = s.parseCard8();
          if (0 === i) for (var u = 0; u < r; u++) {
            if (n <= (a = s.parseCard8())) throw new Error('CFF table CID Font FDSelect has bad FD index value ' + a + ' (FD count ' + n + ')');
            o.push(a);
          } else {
            ...
            for (var h = 0; h < p; h++) {
              if (a = s.parseCard8(), l = s.parseCard16(), n <= a) throw new Error('CFF table CID Font FDSelect has bad FD index value ' + a + ' (FD count ' + n + ')');
      ...
      if (a.defaultWidthX = S.defaultWidthX, a.nominalWidthX = S.nominalWidthX, 0 !== S.subrs) {
        var x = b + S.subrs,
          T = Oe(r, x);
        a.subrs = T.objects, a.subrsBias = Ue(a.subrs);
      } else a.subrs = [], a.subrsBias = 0;
      e.lowMemory ? (y = function (e, t) {
        var r,
          n,
          a = [],
          o = ie.getCard16(e, t);
        if (0 !== o) {
          ...
          r = t + (o + 1) * s + 2;
          for (var i = t + 3, u = 0; u < o + 1; u += 1) a.push(ie.getOffset(e, i, s)), i += s;
          n = r + a[o];
        } else n = t + 2;
        return {
          offsets: a,
      ...
      }(r, n + f.charStrings), a.nGlyphs = y.offsets.length) : (y = Oe(r, n + f.charStrings), a.nGlyphs = y.objects.length);
      var k = function (e, t, r, n) {
        ...
        var i = ['.notdef'],
          u = s.parseCard8();
        if (0 === u) for (var l = 0; l < r; l += 1) a = s.parseSID(), i.push(Le(n, a));else if (1 === u) for (; i.length <= r;) {
      ...
      if (0 === f.encoding ? a.cffEncoding = new ge(pe, k) : 1 === f.encoding ? a.cffEncoding = new ge(ce, k) : a.cffEncoding = function (e, t, r) {
        var n,
          a = {},
          o = new ie.Parser(e, t),
          s = o.parseCard8();
        if (0 === s) for (var i = o.parseCard8(), u = 0; u < i; u += 1) a[n = o.parseCard8()] = u;else {
          if (1 !== s) throw new Error('Unknown encoding format ' + s);
          var l = o.parseCard8();
          n = 1;
          for (var p = 0; p < l; p += 1) for (var c = o.parseCard8(), h = o.parseCard8(), f = c; f <= c + h; f += 1) a[f] = n, n += 1;
        }
        return new ge(a, r);
      }(r, n + f.encoding, k), a.encoding = a.encoding || a.cffEncoding, a.glyphs = new Te.GlyphSet(a), e.lowMemory) a._push = function (e) {
      ...
      };else for (var U = 0; U < a.nGlyphs; U += 1) {
        var O = y.objects[U];
    ...
    make: function make(e, t) {
      ...
      var l,
        ...
        c,
        h = Ae(o, u);
      n.topDictIndex = Pe(h), n.globalSubrIndex = new $.Record('Global Subr INDEX', [{
        name: 'subrs',
        type: 'INDEX',
        value: []
        ...
        return r;
      }(s, u), n.charStringsIndex = function (e) {
        ...
        return t;
      }(e), n.privateDict = (l = {}, p = u, (c = new $.Record('Private DICT', [{
        name: 'dict',
        type: 'DICT',
        value: {}
      }])).dict = Fe(De, l, p), c), n.stringIndex = function (e) {
      ...
      var f = n.header.sizeOf() + n.nameIndex.sizeOf() + n.topDictIndex.sizeOf() + n.stringIndex.sizeOf() + n.globalSubrIndex.sizeOf();
      return o.charset = f, o.encoding = 0, o.charStrings = o.charset + n.charsets.sizeOf(), o["private"][1] = o.charStrings + n.charStringsIndex.sizeOf(), h = Ae(o, u), n.topDictIndex = Pe(h), n;
    }
  };
  var ze = {
    parse: function parse(e, t) {
  ...
  var qe = {
    parse: function parse(e, t, r, n, a, o, s) {
      s.lowMemory ? function (e, t, r, n, a) {
        var o, s;
        e._hmtxTableData = {};
        for (var i = new ie.Parser(t, r), u = 0; u < a; u += 1) u < n && (o = i.parseUShort(), s = i.parseShort()), e._hmtxTableData[u] = {
          advanceWidth: o,
          leftSideBearing: s
        };
      }(e, t, r, n, a) : function (e, t, r, n, a) {
  ...
  var Xe = {
    ...
    Ve = ['copyright', 'fontFamily', 'fontSubfamily', 'uniqueID', 'fullName', 'version', 'postScriptName', 'trademark', 'manufacturer', 'designer', 'description', 'manufacturerURL', 'designerURL', 'license', 'licenseURL', 'reserved', 'preferredFamily', 'preferredSubfamily', 'compatibleFullName', 'sampleText', 'postScriptFindFontName', 'wwsFamily', 'wwsSubfamily'],
    Ye = {
      0: 'en',
      1: 'fr',
      2: 'de',
  ...
  var at = {
      parse: function parse(e, t, r) {
        for (var n = {}, a = new ie.Parser(e, t), o = a.parseUShort(), s = a.parseUShort(), i = a.offset + a.parseUShort(), u = 0; u < s; u++) {
          var l = a.parseUShort(),
            p = a.parseUShort(),
            c = a.parseUShort(),
            h = a.parseUShort(),
          ...
          if (void 0 !== m && void 0 !== v) {
            var y = void 0;
            if (y = m === Ke ? I.UTF16(e, i + g, d) : I.MACSTRING(e, i + g, d, m)) {
              var b = n[f];
      ...
      make: function make(e, t) {
        ...
        for (var s in e) {
          var i = o[s];
          if (void 0 === i && (i = s), r = parseInt(i), isNaN(r)) throw new Error('Name table entry "' + s + '" does not exist, see nameTableNames for complete list.');
          a[r] = e[s], n.push(r);
        }
        for (var u = tt(Ye), l = tt(Ze), p = [], c = [], h = 0; h < n.length; h++) {
          var f = a[r = n[h]];
          for (var d in f) {
            var g = f[d],
              v = 1,
              ...
              b = et(v, y, m),
              S = M.MACSTRING(g, b);
            void 0 === S && (v = 0, (m = t.indexOf(d)) < 0 && (m = t.length, t.push(d)), y = 4, S = M.UTF16(g));
            var x = nt(S, c);
      ...
      parse: function parse(e, t) {
        ...
        switch (r.version = n.parseVersion(), r.italicAngle = n.parseFixed(), r.underlinePosition = n.parseShort(), r.underlineThickness = n.parseShort(), r.isFixedPitch = n.parseULong(), r.minMemType42 = n.parseULong(), r.maxMemType42 = n.parseULong(), r.minMemType1 = n.parseULong(), r.maxMemType1 = n.parseULong(), r.version) {
          ...
          case 2:
            ...
            r.names = [];
            for (var o = 0; o < r.numberOfGlyphs; o++) if (r.glyphNameIndex[o] >= he.length) {
              var s = n.parseChar();
  ...
  pt[1] = function (e) {
    ...
    if (1 === e.substFormat) return new $.Table('chainContextTable', [{
      name: 'substFormat',
      type: 'USHORT',
      value: e.substFormat
    }, {
      ...
      return new $.Table('chainRuleSetTable', $.tableList('chainRule', e, function (e) {
        var r = $.ushortList('backtrackGlyph', e.backtrack, e.backtrack.length).concat($.ushortList('inputGlyph', e.input, e.input.length + 1)).concat($.ushortList('lookaheadGlyph', e.lookahead, e.lookahead.length)).concat($.ushortList('substitution', [], e.lookupRecords.length));
        return e.lookupRecords.forEach(function (e, t) {
          r = r.concat({
    ...
    if (2 === e.substFormat) w.assert(!1, 'lookup type 6 format 2 is not yet supported.');else if (3 === e.substFormat) {
      var r = [{
        name: 'substFormat',
        type: 'USHORT',
        value: e.substFormat
  ...
  function vt(e) {
    ...
    for (var n = [], a = [], o = t.sizeOf() + gt().sizeOf() * t.numTables; o % 4 != 0;) o += 1, a.push({
      name: 'padding',
      type: 'BYTE',
      value: 0
    });
    for (var s = 0; s < e.length; s += 1) {
      var i = e[s];
      w.argument(4 === i.tableName.length, 'Table name' + i.tableName + ' is invalid.');
      var u = i.sizeOf(),
      ...
      for (n.push({
        ...
        type: 'RECORD',
        value: i
      }), o += u, w.argument(!isNaN(o), 'Something went wrong calculating the offset.'); o % 4 != 0;) o += 1, a.push({
        name: 'padding',
        type: 'BYTE',
        value: 0
      });
  ...
  var yt = {
    ...
    fontToTable: function fontToTable(e) {
      for (var t, r = [], n = [], a = [], o = [], s = [], i = [], u = [], l = 0, p = 0, c = 0, h = 0, f = 0, d = 0; d < e.glyphs.length; d += 1) {
        ...
        if (m < 32) p |= 1 << m;else if (m < 64) c |= 1 << m - 32;else if (m < 96) h |= 1 << m - 64;else {
      ...
      var I = [],
        ...
        A = e.metas && 0 < Object.keys(e.metas).length ? ht.make(e.metas) : void 0,
        P = [S, x, T, k, M, O, B, F, U];
      G && P.push(G), e.tables.gsub && P.push(ct.make(e.tables.gsub)), A && P.push(A);
      for (var N = vt(P), H = dt(N.encode()), z = N.fields, W = !1, q = 0; q < z.length; q += 1) if ('head table' === z[q].name) {
        z[q].value.checkSumAdjustment = 2981146554 - H, W = !0;
        break;
      }
      if (!W) throw new Error('Could not find head table with checkSum to adjust.');
      return N;
    },
    computeCheckSum: dt
  };
  ...
  function wt(e, t, r) {
    ...
    if (e.numberOfContours = o.parseShort(), e._xMin = o.parseShort(), e._yMin = o.parseShort(), e._xMax = o.parseShort(), e._yMax = o.parseShort(), 0 < e.numberOfContours) {
      for (var s = e.endPointIndices = [], i = 0; i < e.numberOfContours; i += 1) s.push(o.parseUShort());
      e.instructionLength = o.parseUShort(), e.instructions = [];
      for (var u = 0; u < e.instructionLength; u += 1) e.instructions.push(o.parseByte());
      var l = s[s.length - 1] + 1;
      n = [];
      for (var p = 0; p < l; p += 1) if (a = o.parseByte(), n.push(a), 0 < (8 & a)) for (var c = o.parseByte(), h = 0; h < c; h += 1) n.push(a), p += 1;
      if (w.argument(n.length === l, 'Bad flags.'), 0 < s.length) {
        var f,
          d = [];
        if (0 < l) {
          for (var g = 0; g < l; g += 1) a = n[g], (f = {}).onCurve = !!(1 & a), f.lastPointOfContour = 0 <= s.indexOf(g), d.push(f);
          for (var v = 0, m = 0; m < l; m += 1) a = n[m], (f = d[m]).x = Ct(o, a, v, 2, 16), v = f.x;
          for (var y = 0, b = 0; b < l; b += 1) a = n[b], (f = d[b]).y = Ct(o, a, y, 4, 32), y = f.y;
        }
        e.points = d;
      } else e.points = [];
      ...
      for (var S = !0; S;) {
        ...
        0 < (1 & n) ? 0 < (2 & n) ? (x.dx = o.parseShort(), x.dy = o.parseShort()) : x.matchedPoints = [o.parseUShort(), o.parseUShort()] : 0 < (2 & n) ? (x.dx = o.parseChar(), x.dy = o.parseChar()) : x.matchedPoints = [o.parseByte(), o.parseByte()], 0 < (8 & n) ? x.xScale = x.yScale = o.parseF2Dot14() : 0 < (64 & n) ? (x.xScale = o.parseF2Dot14(), x.yScale = o.parseF2Dot14()) : 0 < (128 & n) && (x.xScale = o.parseF2Dot14(), x.scale01 = o.parseF2Dot14(), x.scale10 = o.parseF2Dot14(), x.yScale = o.parseF2Dot14()), e.components.push(x), S = !!(32 & n);
      }
      if (256 & n) {
        e.instructionLength = o.parseUShort(), e.instructions = [];
        for (var T = 0; T < e.instructionLength; T += 1) e.instructions.push(o.parseByte());
      }
    }
  }
  function Dt(e, t) {
  ...
  function It(e) {
    ...
    for (var r = function (e) {
      ...
      var a = r[n],
        ...
        s = a[a.length - 1],
        i = a[0];
      if (s.onCurve) t.moveTo(s.x, s.y);else if (i.onCurve) t.moveTo(i.x, i.y);else {
        var u = {
          x: 0.5 * (s.x + i.x),
          y: 0.5 * (s.y + i.y)
        };
      ...
      for (var l = 0; l < a.length; ++l) if (o = s, s = i, i = a[(l + 1) % a.length], s.onCurve) t.lineTo(s.x, s.y);else {
        var p = i;
  ...
  function Mt(e, t) {
    if (t.isComposite) for (var r = 0; r < t.components.length; r += 1) {
      ...
      if (a.getPath(), a.points) {
        var o = void 0;
        if (void 0 === n.matchedPoints) o = Dt(a.points, n);else {
          ...
          i = Dt([i], u)[0], u.dx = s.x - i.x, u.dy = s.y - i.y, o = Dt(a.points, u);
        }
  ...
  (kt.prototype = Tt.prototype = {
    ...
    getFeatureTable: function getFeatureTable(e, t, r, n) {
      ...
      if (a) {
        ...
        if (n) {
          var l = i.length;
          return w.assert(0 === l || r >= i[l - 1].tag, 'Features must be added in alphabetical order.'), o = {
            tag: r,
            feature: {
              params: 0,
              lookupListIndexes: []
    ...
    getLookupTables: function getLookupTables(e, t, r, n, a) {
      var o = this.getFeatureTable(e, t, r, a),
        s = [];
      if (o) {
        for (var i, u = o.lookupListIndexes, l = this.font.tables[this.tableName].lookups, p = 0; p < u.length; p++) (i = l[u[p]]).lookupType === n && s.push(i);
        if (0 === s.length && a) {
          i = {
            lookupType: n,
            lookupFlag: 0,
    ...
    for (var n = [], a = this.getLookupTables(t, r, e, 1), o = 0; o < a.length; o++) for (var s = a[o].subtables, i = 0; i < s.length; i++) {
      var u = s[i],
    ...
    for (var n = [], a = this.getLookupTables(t, r, e, 2), o = 0; o < a.length; o++) for (var s = a[o].subtables, i = 0; i < s.length; i++) {
      var u = s[i],
        l = this.expandCoverage(u.coverage),
        p = void 0;
      for (p = 0; p < l.length; p++) {
    ...
    for (var n = [], a = this.getLookupTables(t, r, e, 3), o = 0; o < a.length; o++) for (var s = a[o].subtables, i = 0; i < s.length; i++) for (var u = s[i], l = this.expandCoverage(u.coverage), p = u.alternateSets, c = 0; c < l.length; c++) n.push({
      sub: l[c],
      by: p[c]
    });
    return n;
  }, Ut.prototype.getLigatures = function (e, t, r) {
    for (var n = [], a = this.getLookupTables(t, r, e, 4), o = 0; o < a.length; o++) for (var s = a[o].subtables, i = 0; i < s.length; i++) for (var u = s[i], l = this.expandCoverage(u.coverage), p = u.ligatureSets, c = 0; c < l.length; c++) for (var h = l[c], f = p[c], d = 0; d < f.length; d++) {
      var g = f[d];
      n.push({
    ...
    w.assert(t.by instanceof Array && 1 < t.by.length, 'Multiple: "by" must be an array of two or more ids');
    ...
    o || (o = {
      ...
      ligatureSets: []
    }, a.subtables[0] = o), w.assert(1 === o.coverage.format, 'Ligature: unable to modify coverage table format ' + o.coverage.format);
    var s = t.sub[0],
      i = t.sub.slice(1),
      u = {
        ligGlyph: t.by,
    ...
    if (0 <= l) {
      for (var p = o.ligatureSets[l], c = 0; c < p.length; c++) if (Ot(p[c].components, i)) return;
      p.push(u);
  ...
  var Gt,
    ...
    Pt = {
      getPath: It,
      parse: function parse(e, t, r, n, a) {
        return a.lowMemory ? (o = e, s = t, i = r, u = n, l = new Te.GlyphSet(u), u._push = function (e) {
          var t = i[e];
          t !== i[e + 1] ? l.push(e, Te.ttfGlyphLoader(u, e, wt, o, s + t, Mt)) : l.push(e, Te.glyphLoader(u, e));
        }, l) : function (e, t, r, n) {
          for (var a = new Te.GlyphSet(n), o = 0; o < r.length - 1; o += 1) {
            var s = r[o];
            s !== r[o + 1] ? a.push(o, Te.ttfGlyphLoader(n, o, wt, e, t + s, Mt)) : a.push(o, Te.glyphLoader(n, o));
          }
          return a;
        }(e, t, r, n);
        var o, s, i, u, l;
  ...
  var Yt = {
      ...
      interpolate: function interpolate(e, t, r, n) {
        var a, o, s, i, u, l, p;
        if (!n || n === this) return a = e.xo - t.xo, o = e.xo - r.xo, u = t.x - t.xo, l = r.x - r.xo, 0 === (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? void (e.x = e.xo + (u + l) / 2) : void (e.x = e.xo + (u * i + l * s) / p);
        a = n.distance(e, t, !0, !0), o = n.distance(e, r, !0, !0), u = n.distance(t, t, !1, !0), l = n.distance(r, r, !1, !0), 0 !== (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? Yt.setRelative(e, e, (u * i + l * s) / p, n, !0) : Yt.setRelative(e, e, (u + l) / 2, n, !0);
      },
      normalSlope: Number.NEGATIVE_INFINITY,
      setRelative: function setRelative(e, t, r, n, a) {
        if (n && n !== this) {
          var o = a ? t.xo : t.x,
            s = a ? t.yo : t.y,
            i = o + r * n.x,
    ...
    jt = {
      ...
      interpolate: function interpolate(e, t, r, n) {
        var a, o, s, i, u, l, p;
        if (!n || n === this) return a = e.yo - t.yo, o = e.yo - r.yo, u = t.y - t.yo, l = r.y - r.yo, 0 === (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? void (e.y = e.yo + (u + l) / 2) : void (e.y = e.yo + (u * i + l * s) / p);
        a = n.distance(e, t, !0, !0), o = n.distance(e, r, !0, !0), u = n.distance(t, t, !1, !0), l = n.distance(r, r, !1, !0), 0 !== (p = (s = Math.abs(a)) + (i = Math.abs(o))) ? jt.setRelative(e, e, (u * i + l * s) / p, n, !0) : jt.setRelative(e, e, (u + l) / 2, n, !0);
      },
      normalSlope: 0,
      setRelative: function setRelative(e, t, r, n, a) {
        if (n && n !== this) {
  ...
  function Qt(e, t) {
    ...
    return t /= r, 1 === (e /= r) && 0 === t ? Yt : 0 === e && 1 === t ? jt : new Zt(e, t);
  }
  function Kt(e, t, r, n) {
  ...
  Object.freeze(Yt), Object.freeze(jt), Zt.prototype.distance = function (e, t, r, n) {
    return this.x * Yt.distance(e, t, r, n) + this.y * jt.distance(e, t, r, n);
  }, Zt.prototype.interpolate = function (e, t, r, n) {
    var a, o, s, i, u, l, p;
    s = n.distance(e, t, !0, !0), i = n.distance(e, r, !0, !0), a = n.distance(t, t, !1, !0), o = n.distance(r, r, !1, !0), 0 !== (p = (u = Math.abs(s)) + (l = Math.abs(i))) ? this.setRelative(e, e, (a * l + o * u) / p, n, !0) : this.setRelative(e, e, (a + o) / 2, n, !0);
  ...
  function tr(e) {
    for (var t = e.tZone = new Array(e.gZone.length), r = 0; r < t.length; r++) t[r] = new Kt(0, 0);
  }
  function rr(e, t) {
    var r,
      n = e.prog,
  ...
  function nr(e, t) {
    O.DEBUG && console.log(t.step, 'SVTCA[' + e.axis + ']'), t.fv = t.pv = t.dpv = e;
  }
  function ar(e, t) {
    O.DEBUG && console.log(t.step, 'SPVTCA[' + e.axis + ']'), t.pv = t.dpv = e;
  }
  function or(e, t) {
  ...
  function sr(e, t) {
    var r,
      ...
      i = t.z2[o],
      u = t.z1[s];
    O.DEBUG && console.log('SPVTL[' + e + ']', o, s), n = e ? (r = i.y - u.y, u.x - i.x) : (r = u.x - i.x, u.y - i.y), t.pv = t.dpv = Qt(r, n);
  }
  function ir(e, t) {
    var r,
      n,
      ...
      i = t.z2[o],
      u = t.z1[s];
    O.DEBUG && console.log('SFVTL[' + e + ']', o, s), n = e ? (r = i.y - u.y, u.x - i.x) : (r = u.x - i.x, u.y - i.y), t.fv = Qt(r, n);
  }
  function ur(e) {
  ...
  function lr(e, t) {
    ...
    e && (s = t.round(s)), a.setRelative(n, Jt, s, o), a.touch(n), t.rp0 = t.rp1 = r;
  }
  function pr(e, t) {
    var r,
      n,
  ...
  function cr(e, t) {
    for (var r = t.stack, n = e ? t.rp1 : t.rp2, a = (e ? t.z0 : t.z1)[n], o = t.fv, s = t.pv, i = t.loop, u = t.z2; i--;) {
      ...
      o.setRelative(p, p, c, s), o.touch(p), O.DEBUG && console.log(t.step, (1 < t.loop ? 'loop ' + (t.loop - i) + ': ' : '') + 'SHP[' + (e ? 'rp1' : 'rp2') + ']', l);
    }
    t.loop = 1;
  }
  function hr(e, t) {
    ...
    for (var p = s.distance(a, a, !1, !0); l !== a && o.setRelative(l, l, p, s), (l = l.nextPointOnContour) !== u;);
  }
  function fr(e, t) {
    var r,
      n,
    ...
    for (var p = u.distance(s, s, !1, !0), c = r.length - 2, h = 0; h < c; h++) n = r[h], i.setRelative(n, n, p, u);
  }
  function dr(e, t) {
    var r = t.stack,
      n = r.pop() / 64,
      ...
      i = t.fv,
      u = t.pv;
    i.setRelative(o, s, n, u), i.touch(o), O.DEBUG && console.log(t.step, 'MSIRP[' + e + ']', n, a), t.rp1 = t.rp0, t.rp2 = a, e && (t.rp0 = a);
  }
  function gr(e, t) {
    var r = t.stack,
      n = r.pop(),
    ...
    e && (Math.abs(l - u) < t.cvCutIn && (l = u), l = t.round(l)), s.setRelative(o, Jt, l, i), 0 === t.zp0 && (o.xo = o.x, o.yo = o.y), s.touch(o), t.rp0 = t.rp1 = a;
  }
  function vr(e, t) {
    var r = t.stack,
      n = r.pop(),
      a = t.z2[n];
    O.DEBUG && console.log(t.step, 'GC[' + e + ']', n), r.push(64 * t.dpv.distance(a, Jt, e, !1));
  }
  function mr(e, t) {
    var r = t.stack,
      n = r.pop(),
    ...
    O.DEBUG && console.log(t.step, 'MD[' + e + ']', n, a, '->', i), t.stack.push(Math.round(64 * i));
  }
  function yr(e, t) {
    var r = t.stack,
      n = r.pop(),
    ...
    for (var p = 0; p < n; p++) {
      ...
      if (i + ((240 & h) >> 4) === s) {
        var f = (15 & h) - 8;
        0 <= f && f++, O.DEBUG && console.log(t.step, 'DELTAPFIX', c, 'by', f * u);
        var d = l[c];
  ...
  function Sr(e, t) {
    ...
    for (var i = 0; i < n; i++) {
      ...
      if (o + ((240 & l) >> 4) === a) {
        ...
        0 <= p && p++;
        var c = p * s;
        O.DEBUG && console.log(t.step, 'DELTACFIX', u, 'by', c), t.cvt[u] += c;
      }
    }
  }
  function xr(e, t) {
    var r,
      ...
      i = t.z2[o],
      u = t.z1[s];
    O.DEBUG && console.log(t.step, 'SDPVTL[' + e + ']', o, s), n = e ? (r = i.y - u.y, u.x - i.x) : (r = u.x - i.x, u.y - i.y), t.dpv = Qt(r, n);
  }
  function Tr(e, t) {
    var r = t.stack,
      n = t.prog,
  ...
  function Ur(e, t, r, n, a, o) {
    var s,
      ...
      m = o.fv,
      y = o.dpv;
    u = 0 <= (i = s = y.distance(g, d, !0, !0)) ? 1 : -1, i = Math.abs(i), e && (l = o.cvt[c], n && Math.abs(i - l) < o.cvCutIn && (i = l)), r && i < v && (i = v), n && (i = o.round(i)), m.setRelative(g, d, u * i, y), m.touch(g), O.DEBUG && console.log(o.step, (e ? 'MIRP[' : 'MDRP[') + (t ? 'M' : 'm') + (r ? '>' : '_') + (n ? 'R' : '_') + (0 === a ? 'Gr' : 1 === a ? 'Bl' : 2 === a ? 'Wh' : '') + ']', e ? c + '(' + o.cvt[c] + ',' + l + ')' : '', h, '(d =', s, '->', u * i, ')'), o.rp1 = o.rp0, o.rp2 = h, t && (o.rp0 = h);
  }
  function Or(e) {
  ...
  function wr(e) {
    this.tokens = [], this.registeredContexts = {}, this.contextCheckers = [], this.events = {}, this.registeredModifiers = [], function (r) {
      var n = this,
        e = ['start', 'end', 'next', 'newToken', 'contextStart', 'contextEnd', 'insertToken', 'removeToken', 'removeRange', 'replaceToken', 'replaceRange', 'composeRUD', 'updateContextsRanges'];
      e.forEach(function (e) {
        Object.defineProperty(n.events, e, {
          value: new Cr(e)
        });
  ...
  Nt.prototype.exec = function (e, t) {
    ...
    if (!(2 < this._errorState)) {
      ...
      if (!n || n.ppem !== t) {
        ...
        if (!a) {
          er.prototype = $t, (a = this._fpgmState = new er('fpgm', r.tables.fpgm)).funcs = [], a.font = r, O.DEBUG && (console.log('---EXEC FPGM---'), a.step = -1);
          try {
            Bt(a);
          } catch (e) {
        ...
        er.prototype = a, (n = this._prepState = new er('prep', r.tables.prep)).ppem = t;
        var o = r.tables.cvt;
        if (o) for (var s = n.cvt = new Array(o.length), i = t / r.unitsPerEm, u = 0; u < o.length; u++) s[u] = o[u] * i;else n.cvt = [];
    ...
    if (er.prototype = t, i) {
      ...
      for (var l = 0; l < i.length; l++) {
        ...
        a = new er('glyf', c.instructions), O.DEBUG && (console.log('---EXEC COMP ' + l + '---'), a.step = -1), At(c, a, o, s);
        for (var h = Math.round(p.dx * o), f = Math.round(p.dy * s), d = a.gZone, g = a.contours, v = 0; v < d.length; v++) {
          var m = d[v];
      ...
      e.instructions && !a.inhibitGridFit && ((a = new er('glyf', e.instructions)).gZone = a.z0 = a.z1 = a.z2 = n, a.contours = r, n.push(new Kt(0, 0), new Kt(Math.round(e.advanceWidth * o), 0)), O.DEBUG && (console.log('---EXEC COMPOSITE---'), a.step = -1), Bt(a), n.length -= 2);
    } else a = new er('glyf', e.instructions), O.DEBUG && (console.log('---EXEC GLYPH---'), a.step = -1), At(e, a, o, s), n = a.gZone;
    return n;
  }, At = function At(e, t, r, n) {
    for (var a, o, s, i = e.points || [], u = i.length, l = t.gZone = t.z0 = t.z1 = t.z2 = [], p = t.contours = [], c = 0; c < u; c++) a = i[c], l[c] = new Kt(a.x * r, a.y * n, a.lastPointOfContour, a.onCurve);
    for (var h = 0; h < u; h++) a = l[h], o || (o = a, p.push(h)), a.lastPointOfContour ? ((a.nextPointOnContour = o).prevPointOnContour = a, o = void 0) : (s = l[h + 1], (a.nextPointOnContour = s).prevPointOnContour = a);
    if (!t.inhibitGridFit) {
      if (O.DEBUG) {
        console.log('PROCESSING GLYPH', t.stack);
        for (var f = 0; f < u; f++) console.log(f, l[f].x, l[f].y);
      }
      if (l.push(new Kt(0, 0), new Kt(Math.round(e.advanceWidth * r), 0)), Bt(t), l.length -= 2, O.DEBUG) {
    ...
    if (t) {
      ...
      for (e.ip = 0; e.ip < n; e.ip++) {
        if (O.DEBUG && e.step++, !(r = Gt[t[e.ip]])) throw new Error('unknown instruction: 0x' + Number(t[e.ip]).toString(16));
        r(e);
      }
    }
  }, Gt = [nr.bind(void 0, jt), nr.bind(void 0, Yt), ar.bind(void 0, jt), ar.bind(void 0, Yt), or.bind(void 0, jt), or.bind(void 0, Yt), sr.bind(void 0, 0), sr.bind(void 0, 1), ir.bind(void 0, 0), ir.bind(void 0, 1), function (e) {
    var t = e.stack,
      r = t.pop(),
      n = t.pop();
    O.DEBUG && console.log(e.step, 'SPVFS[]', r, n), e.pv = e.dpv = Qt(n, r);
  }, function (e) {
    var t = e.stack,
      r = t.pop(),
      n = t.pop();
    ...
    var t = e.stack,
      r = e.pv;
    O.DEBUG && console.log(e.step, 'GPV[]'), t.push(16384 * r.x), t.push(16384 * r.y);
  }, function (e) {
    var t = e.stack,
      r = e.fv;
    O.DEBUG && console.log(e.step, 'GFV[]'), t.push(16384 * r.x), t.push(16384 * r.y);
  }, function (e) {
    ...
    var d = l.x,
      ...
      k = d * m - g * v,
      U = y * x - b * S;
    f.x = (k * (y - S) - U * (d - v)) / T, f.y = (k * (b - x) - U * (g - m)) / T;
  }, function (e) {
    e.rp0 = e.stack.pop(), O.DEBUG && console.log(e.step, 'SRP0[]', e.rp0);
  }, function (e) {
    e.rp1 = e.stack.pop(), O.DEBUG && console.log(e.step, 'SRP1[]', e.rp1);
  }, function (e) {
    e.rp2 = e.stack.pop(), O.DEBUG && console.log(e.step, 'SRP2[]', e.rp2);
  }, function (e) {
    var t = e.stack.pop();
    ...
    var t = e.stack.pop();
    switch (O.DEBUG && console.log(e.step, 'SZPS[]', t), e.zp0 = e.zp1 = e.zp2 = t, t) {
      case 0:
    ...
    e.loop = e.stack.pop(), O.DEBUG && console.log(e.step, 'SLOOP[]', e.loop);
  }, function (e) {
    ...
    var t = e.stack,
      r = t.pop();
    O.DEBUG && console.log(e.step, 'MINDEX[]', r), t.push(t.splice(t.length - r, 1)[0]);
    ...
    var a = e.ip,
      o = e.prog;
    e.prog = e.funcs[r];
    for (var s = 0; s < n; s++) Bt(e), O.DEBUG && console.log(++e.step, s + 1 < n ? 'next loopcall' : 'done loopcall', s);
    e.ip = a, e.prog = o;
  }, function (e) {
    var t = e.stack.pop();
    ...
    var r = e.ip,
      n = e.prog;
    e.prog = e.funcs[t], Bt(e), e.ip = r, e.prog = n, O.DEBUG && console.log(++e.step, 'returning from', t);
  }, function (e) {
  ...
  }, void 0, lr.bind(void 0, 0), lr.bind(void 0, 1), pr.bind(void 0, jt), pr.bind(void 0, Yt), cr.bind(void 0, 0), cr.bind(void 0, 1), hr.bind(void 0, 0), hr.bind(void 0, 1), fr.bind(void 0, 0), fr.bind(void 0, 1), function (e) {
    for (var t = e.stack, r = e.loop, n = e.fv, a = t.pop() / 64, o = e.z2; r--;) {
      var s = t.pop(),
        i = o[s];
      O.DEBUG && console.log(e.step, (1 < e.loop ? 'loop ' + (e.loop - r) + ': ' : '') + 'SHPIX[]', s, a), n.setRelative(i, i, a), n.touch(i);
    }
    e.loop = 1;
  }, function (e) {
    for (var t = e.stack, r = e.rp1, n = e.rp2, a = e.loop, o = e.z0[r], s = e.z1[n], i = e.fv, u = e.dpv, l = e.z2; a--;) {
      var p = t.pop(),
        c = l[p];
      O.DEBUG && console.log(e.step, (1 < e.loop ? 'loop ' + (e.loop - a) + ': ' : '') + 'IP[]', p, r, '<->', n), i.interpolate(c, o, s, u), i.touch(c);
    }
    e.loop = 1;
    ...
    for (var t = e.stack, r = e.rp0, n = e.z0[r], a = e.loop, o = e.fv, s = e.pv, i = e.z1; a--;) {
      var u = t.pop(),
        l = i[u];
      O.DEBUG && console.log(e.step, (1 < e.loop ? 'loop ' + (e.loop - a) + ': ' : '') + 'ALIGNRP[]', u), o.setRelative(l, n, 0, s), o.touch(l);
    }
    e.loop = 1;
  }, function (e) {
  ...
  }, vr.bind(void 0, 0), vr.bind(void 0, 1), void 0, mr.bind(void 0, 0), mr.bind(void 0, 1), function (e) {
    ...
    var t = e.stack,
      r = t.pop();
    O.DEBUG && console.log(e.step, 'ODD[]', r), t.push(Math.trunc(r) % 2 ? 1 : 0);
  }, function (e) {
    var t = e.stack,
      r = t.pop();
    O.DEBUG && console.log(e.step, 'EVEN[]', r), t.push(Math.trunc(r) % 2 ? 0 : 1);
  }, function (e) {
    var t = e.stack.pop();
    O.DEBUG && console.log(e.step, 'IF[]', t), t || (rr(e, !0), O.DEBUG && console.log(e.step, 'EIF[]'));
  }, function (e) {
    ...
    var t = e.stack.pop();
    O.DEBUG && console.log(e.step, 'SDS[]', t), e.deltaShift = Math.pow(0.5, t);
  }, function (e) {
    var t = e.stack,
      r = t.pop(),
      n = t.pop();
    ...
    var t = e.stack,
      r = t.pop();
    O.DEBUG && console.log(e.step, 'FLOOR[]', r), t.push(64 * Math.floor(r / 64));
  }, function (e) {
    var t = e.stack,
      r = t.pop();
    O.DEBUG && console.log(e.step, 'CEILING[]', r), t.push(64 * Math.ceil(r / 64));
  }, br.bind(void 0, 0), br.bind(void 0, 1), br.bind(void 0, 2), br.bind(void 0, 3), void 0, void 0, void 0, void 0, function (e) {
    var t = e.stack,
      r = t.pop(),
      n = t.pop();
    O.DEBUG && console.log(e.step, 'WCVTF[]', r, n), e.cvt[n] = r * e.ppem / e.font.unitsPerEm;
  }, yr.bind(void 0, 2), yr.bind(void 0, 3), Sr.bind(void 0, 1), Sr.bind(void 0, 2), Sr.bind(void 0, 3), function (e) {
    var t,
      r = e.stack.pop();
    switch (O.DEBUG && console.log(e.step, 'SROUND[]', r), e.round = Vt, 192 & r) {
      case 0:
        t = 0.5;
        break;
      case 64:
    ...
    var t,
      r = e.stack.pop();
    switch (O.DEBUG && console.log(e.step, 'S45ROUND[]', r), e.round = Vt, 192 & r) {
      case 0:
        t = Math.sqrt(2) / 2;
        break;
      case 64:
  ...
  }, ur, ur, void 0, void 0, void 0, void 0, void 0, function (e) {
    var t = e.stack.pop();
    ...
    var t = e.stack,
      r = t.pop(),
      n = 0;
    O.DEBUG && console.log(e.step, 'GETINFO[]', r), 1 & r && (n = 35), 32 & r && (n |= 4096), t.push(n);
  }, void 0, function (e) {
    var t = e.stack,
      r = t.pop(),
      n = t.pop(),
      a = t.pop();
    O.DEBUG && console.log(e.step, 'ROLL[]'), t.push(n), t.push(r), t.push(a);
  }, function (e) {
    var t = e.stack,
      r = t.pop(),
      n = t.pop();
  ...
  }, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, Tr.bind(void 0, 1), Tr.bind(void 0, 2), Tr.bind(void 0, 3), Tr.bind(void 0, 4), Tr.bind(void 0, 5), Tr.bind(void 0, 6), Tr.bind(void 0, 7), Tr.bind(void 0, 8), kr.bind(void 0, 1), kr.bind(void 0, 2), kr.bind(void 0, 3), kr.bind(void 0, 4), kr.bind(void 0, 5), kr.bind(void 0, 6), kr.bind(void 0, 7), kr.bind(void 0, 8), Ur.bind(void 0, 0, 0, 0, 0, 0), Ur.bind(void 0, 0, 0, 0, 0, 1), Ur.bind(void 0, 0, 0, 0, 0, 2), Ur.bind(void 0, 0, 0, 0, 0, 3), Ur.bind(void 0, 0, 0, 0, 1, 0), Ur.bind(void 0, 0, 0, 0, 1, 1), Ur.bind(void 0, 0, 0, 0, 1, 2), Ur.bind(void 0, 0, 0, 0, 1, 3), Ur.bind(void 0, 0, 0, 1, 0, 0), Ur.bind(void 0, 0, 0, 1, 0, 1), Ur.bind(void 0, 0, 0, 1, 0, 2), Ur.bind(void 0, 0, 0, 1, 0, 3), Ur.bind(void 0, 0, 0, 1, 1, 0), Ur.bind(void 0, 0, 0, 1, 1, 1), Ur.bind(void 0, 0, 0, 1, 1, 2), Ur.bind(void 0, 0, 0, 1, 1, 3), Ur.bind(void 0, 0, 1, 0, 0, 0), Ur.bind(void 0, 0, 1, 0, 0, 1), Ur.bind(void 0, 0, 1, 0, 0, 2), Ur.bind(void 0, 0, 1, 0, 0, 3), Ur.bind(void 0, 0, 1, 0, 1, 0), Ur.bind(void 0, 0, 1, 0, 1, 1), Ur.bind(void 0, 0, 1, 0, 1, 2), Ur.bind(void 0, 0, 1, 0, 1, 3), Ur.bind(void 0, 0, 1, 1, 0, 0), Ur.bind(void 0, 0, 1, 1, 0, 1), Ur.bind(void 0, 0, 1, 1, 0, 2), Ur.bind(void 0, 0, 1, 1, 0, 3), Ur.bind(void 0, 0, 1, 1, 1, 0), Ur.bind(void 0, 0, 1, 1, 1, 1), Ur.bind(void 0, 0, 1, 1, 1, 2), Ur.bind(void 0, 0, 1, 1, 1, 3), Ur.bind(void 0, 1, 0, 0, 0, 0), Ur.bind(void 0, 1, 0, 0, 0, 1), Ur.bind(void 0, 1, 0, 0, 0, 2), Ur.bind(void 0, 1, 0, 0, 0, 3), Ur.bind(void 0, 1, 0, 0, 1, 0), Ur.bind(void 0, 1, 0, 0, 1, 1), Ur.bind(void 0, 1, 0, 0, 1, 2), Ur.bind(void 0, 1, 0, 0, 1, 3), Ur.bind(void 0, 1, 0, 1, 0, 0), Ur.bind(void 0, 1, 0, 1, 0, 1), Ur.bind(void 0, 1, 0, 1, 0, 2), Ur.bind(void 0, 1, 0, 1, 0, 3), Ur.bind(void 0, 1, 0, 1, 1, 0), Ur.bind(void 0, 1, 0, 1, 1, 1), Ur.bind(void 0, 1, 0, 1, 1, 2), Ur.bind(void 0, 1, 0, 1, 1, 3), Ur.bind(void 0, 1, 1, 0, 0, 0), Ur.bind(void 0, 1, 1, 0, 0, 1), Ur.bind(void 0, 1, 1, 0, 0, 2), Ur.bind(void 0, 1, 1, 0, 0, 3), Ur.bind(void 0, 1, 1, 0, 1, 0), Ur.bind(void 0, 1, 1, 0, 1, 1), Ur.bind(void 0, 1, 1, 0, 1, 2), Ur.bind(void 0, 1, 1, 0, 1, 3), Ur.bind(void 0, 1, 1, 1, 0, 0), Ur.bind(void 0, 1, 1, 1, 0, 1), Ur.bind(void 0, 1, 1, 1, 0, 2), Ur.bind(void 0, 1, 1, 1, 0, 3), Ur.bind(void 0, 1, 1, 1, 1, 0), Ur.bind(void 0, 1, 1, 1, 1, 1), Ur.bind(void 0, 1, 1, 1, 1, 2), Ur.bind(void 0, 1, 1, 1, 1, 3)], Or.prototype.setState = function (e, t) {
    ...
    function t(e) {
      return 'object' == _typeof(e) && e.hasOwnProperty('FAIL');
    }
    var r = this,
      n = e.map(function (e) {
    ...
    if (e instanceof Er) return this.getRangeTokens(e).map(function (e) {
      return e["char"];
    }).join('');
    ...
    var r = this,
      n = this.events[e];
    n instanceof Cr && n.subscribers.forEach(function (e) {
      e.apply(r, t || []);
    });
    ...
    this.contextCheckers.forEach(function (e) {
      ...
      if (!r && e.checkStart(o) && (r = new Er(i, null, t), s.getContext(t).openRange = r, s.dispatch('contextStart', [t, i])), r && e.checkEnd(o)) {
      ...
      case '63':
        return function (e) {
          return function (e, t) {
            ...
            for (var o = e.lookahead.slice(a); o.length && Mr(o[0]["char"]);) o.shift();
            var s = new Lr(o, 0),
            ...
            var l = new Lr(u, 0),
              ...
              c = [];
            if (n.length === t.inputCoverage.length && i.length === t.lookaheadCoverage.length && p.length === t.backtrackCoverage.length) for (var h = 0; h < t.lookupRecords.length; h++) for (var f = t.lookupRecords[h].lookupListIndex, d = this.getLookupByIndex(f), g = 0; g < d.subtables.length; g++) {
              var v = d.subtables[g],
                m = this.getLookupMethod(d, v);
              if ('12' === this.getSubstitutionType(d, v)) for (var y = 0; y < n.length; y++) {
                var b = m(e.get(y));
                b && c.push(b);
              }
            }
    ...
    for (var a = this.getFeatureLookups(n), o = [].concat(t.context), s = 0; s < a.length; s++) for (var i = a[s], u = this.getLookupSubtables(i), l = 0; l < u.length; l++) {
      var p = u[l],
      ...
      switch (c) {
        case '11':
          (f = h(t.current)) && o.splice(r, 1, new Fr({
            id: 11,
            tag: e.tag,
            substitution: f
          }));
        ...
        case '12':
          ...
          break;
        case '63':
          f = h(t), Array.isArray(f) && f.length && o.splice(r, 1, new Fr({
            id: 63,
            tag: e.tag,
            substitution: f
          }));
  ...
  var Nr = {
    startCheck: function startCheck(e) {
      var t = e.current,
        r = e.get(-1);
      return null === r && Dr(t) || !Dr(r) && Dr(t);
    },
    endCheck: function endCheck(e) {
      var t = e.get(1);
      return null === t || !Dr(t);
    }
  };
  ...
  function qr(e) {
    ...
    if (1 !== i.length) {
      var u = new Lr(i.map(function (e) {
          return e.getState('glyphIndex');
        }), 0),
        l = new Lr(i.map(function (e) {
          return e["char"];
        }), 0);
      i.forEach(function (e, t) {
        if (!Mr(e["char"])) {
          ...
          var r,
            n = 0;
          switch (!function (e) {
            for (var t = [].concat(e.backtrack), r = t.length - 1; 0 <= r; r--) {
              var n = t[r],
                a = Ir(n),
                o = Mr(n);
              if (!a && !o) return 1;
            ...
            if (!Ir(e.current)) for (var t = 0; t < e.lookahead.length; t++) {
  ...
  function _r(e, t) {
    return new Lr(e.map(function (e) {
  ...
  function Yr(e) {
    this.baseDir = e || 'ltr', this.tokenizer = new wr(), this.featuresTags = {};
  }
  function jr(e) {
  ...
  function Qr() {
    var t = this;
    this.featuresTags.hasOwnProperty('arab') && -1 !== this.featuresTags.arab.indexOf('rlig') && (Zr.call(this), this.tokenizer.getContextRanges('arabicWord').forEach(function (e) {
      (function (e) {
        var n = this,
  ...
  function Kr() {
    var t = this;
    this.featuresTags.hasOwnProperty('latn') && -1 !== this.featuresTags.latn.indexOf('liga') && (Zr.call(this), this.tokenizer.getContextRanges('latinWord').forEach(function (e) {
      (function (e) {
        var n = this,
          a = this.tokenizer.getRangeTokens(e),
          o = Vr(a);
  ...
  function Jr(e) {
    ...
    })), this.supported = !0, this.glyphs = new Te.GlyphSet(this, e.glyphs || []), this.encoding = new fe(this), this.position = new kt(this), this.substitution = new Ut(this), this.tables = this.tables || {}, this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, 'hinting', {
      get: function get() {
  ...
  Yr.prototype.setText = function (e) {
    ...
    this.checkContextReady('arabicWord') && (function () {
      var t = this;
      this.featuresTags.hasOwnProperty('arab') && (Zr.call(this), this.tokenizer.getContextRanges('arabicWord').forEach(function (e) {
        qr.call(t, e);
      }));
    }.call(this), Qr.call(this)), this.checkContextReady('latinWord') && Kr.call(this), this.checkContextReady('arabicSentence') && function () {
      var r = this;
      this.tokenizer.getContextRanges('arabicSentence').forEach(function (e) {
        var t = r.tokenizer.getRangeTokens(e);
        r.tokenizer.replaceRange(e.startIndex, e.endOffset, t.reverse());
      });
    }.call(this);
  }, Yr.prototype.processText = function (e) {
    this.text && this.text === e || (this.setText(e), function () {
      return jr.call(this, 'latinWord'), jr.call(this, 'arabicWord'), jr.call(this, 'arabicSentence'), this.tokenizer.tokenize(this.text);
    }.call(this), this.applyFeaturesToContexts());
    ...
    for (var o = n.getTextGlyphs(e), s = o.length, i = new Array(s), u = this.glyphs.get(0), l = 0; l < s; l += 1) i[l] = this.glyphs.get(o[l]) || u;
    return i;
    ...
    for (var p = 0; p < u.length; p += 1) {
      var c = u[p];
      if (o.call(this, c, t, r, n, a), c.advanceWidth && (t += c.advanceWidth * i), a.kerning && p < u.length - 1) t += (s ? this.position.getKerningValue(s, c.index, u[p + 1].index) : this.getKerningValue(c, u[p + 1])) * i;
  ...
  var un = {
    make: function make(e, t) {
      ...
      for (var i = 0; i < e.axes.length; i++) s.fields = s.fields.concat((r = i, n = e.axes[i], a = t, o = $r(n.name, a), [{
        name: 'tag_' + r,
        type: 'TAG',
        value: n.tag
      }, {
      ...
      for (var u = 0; u < e.instances.length; u++) s.fields = s.fields.concat(en(u, e.instances[u], e.axes, t));
      return s;
    },
    parse: function parse(e, t, r) {
      var n = new ie.Parser(e, t),
      ...
      n.skip('uShort', 1);
      for (var s, i, u, l, p, c = n.parseUShort(), h = n.parseUShort(), f = n.parseUShort(), d = n.parseUShort(), g = [], v = 0; v < c; v++) g.push((s = e, i = t + o + v * h, u = r, p = l = void 0, l = {}, p = new ie.Parser(s, i), l.tag = p.parseTag(), l.minValue = p.parseFixed(), l.defaultValue = p.parseFixed(), l.maxValue = p.parseFixed(), p.skip('uShort', 1), l.name = u[p.parseUShort()] || {}, l));
      for (var m = [], y = t + o + c * h, b = 0; b < f; b++) m.push(tn(e, y + b * d, g, r));
      return {
        axes: g,
        instances: m
      };
  ...
  pn[1] = function () {
    ...
    if (2 === t) {
      ...
      return {
        ...
        class1Count: i,
        class2Count: u,
        classRecords: this.parseList(i, oe.list(u, function () {
          return {
            value1: this.parseValueRecord(n),
            value2: this.parseValueRecord(a)
          };
  ...
  var dn = {
    parse: function parse(e, t, r, n) {
      for (var a = new ie.Parser(e, t), o = n ? a.parseUShort : a.parseULong, s = [], i = 0; i < r + 1; i += 1) {
        var u = o.call(a);
        n && (u *= 2), s.push(u);
      }
      return s;
  ...
  function bn(e, t) {
    ...
    var a,
      ...
      b = [],
      S = ie.getTag(y, 0);
    if (S === String.fromCharCode(0, 1, 0, 0) || 'true' === S || 'typ1' === S) m.outlinesFormat = 'truetype', b = mn(y, a = ie.getUShort(y, 4));else if ('OTTO' === S) m.outlinesFormat = 'cff', b = mn(y, a = ie.getUShort(y, 4));else {
      if ('wOFF' !== S) throw new Error('Unsupported OpenType signature ' + S);
      var x = ie.getTag(y, 4);
      if (x === String.fromCharCode(0, 1, 0, 0)) m.outlinesFormat = 'truetype';else {
    ...
    for (var T = 0; T < a; T += 1) {
      ...
      switch (k.tag) {
        case 'cmap':
          U = yn(y, k), m.tables.cmap = ue.parse(U.data, U.offset), m.encoding = new de(m.tables.cmap);
          break;
        case 'cvt ':
          U = yn(y, k), v = new ie.Parser(U.data, U.offset), m.tables.cvt = v.parseShortList(k.length / 2);
          break;
        case 'fvar':
          s = k;
          break;
        case 'fpgm':
          U = yn(y, k), v = new ie.Parser(U.data, U.offset), m.tables.fpgm = v.parseByteList(k.length);
          break;
        case 'head':
          U = yn(y, k), m.tables.head = ze.parse(U.data, U.offset), m.unitsPerEm = m.tables.head.unitsPerEm, r = m.tables.head.indexToLocFormat;
          break;
        case 'hhea':
          U = yn(y, k), m.tables.hhea = We.parse(U.data, U.offset), m.ascender = m.tables.hhea.ascender, m.descender = m.tables.hhea.descender, m.numberOfHMetrics = m.tables.hhea.numberOfHMetrics;
          break;
        case 'hmtx':
          c = k;
          break;
        case 'ltag':
          ...
          break;
        case 'maxp':
          U = yn(y, k), m.tables.maxp = Xe.parse(U.data, U.offset), m.numGlyphs = m.tables.maxp.numGlyphs;
          break;
        case 'name':
          d = k;
          break;
        case 'OS/2':
          ...
          break;
        case 'post':
          U = yn(y, k), m.tables.post = it.parse(U.data, U.offset), m.glyphNames = new ve(m.tables.post);
          break;
        case 'prep':
          U = yn(y, k), v = new ie.Parser(U.data, U.offset), m.tables.prep = v.parseByteList(k.length);
          break;
        case 'glyf':
          i = k;
          break;
    ...
    var O = yn(y, d);
    if (m.tables.name = at.parse(O.data, O.offset, n), m.names = m.tables.name, i && f) {
      var E = 0 === r,
        R = yn(y, f),
    ...
    var D = yn(y, c);
    if (qe.parse(m, D.data, D.offset, m.numberOfHMetrics, m.numGlyphs, m.glyphs, t), me(m, t), h) {
      var I = yn(y, h);
  ...
  O.BoundingBox = R, O.Font = Jr, O.Glyph = be, O.Path = B, O._parse = ie, O["default"] = Tn, O.load = Sn, O.loadSync = xn, O.parse = bn, Object.defineProperty(O, '__esModule', {
    value: !0
  });
});

}).call(this)}).call(this,require("buffer").Buffer)
},{"buffer":4,"fs":3}],2:[function(require,module,exports){
'use strict'
